...
from .views import RegisterUserView, LoginUserView, GetAllHospitalsView, TopDoctorsView, RecommendView, PastRecommendView, GetDocByIdView, UserDetailsView, EditDetailsView
